...
openssl aes-256-cbc -k "$SECURITY_PASSWORD" -in scripts/provisioning-profile/inhouse_enterprise_destribution.mobileprovision.enc -d -a -out scripts/provisioning-profile/inhouse_enterprise_destribution.mobileprovision
...
cp "./scripts/provisioning-profile/inhouse_enterprise_destribution.mobileprovision" ~/Library/MobileDevice/Provisioning\ Profiles/
